...
export declare enum ChangeContainerEventType {
    onEnter = "onEnter",
    onLeave = "onLeave"
}
...
export interface ViewContainerDataType {
    ...
    closeView: (view: ViewType<any>, newActiveView: ViewType<any> | undefined, closeType: CloseType) => Promise<any>;
    activateView?: (view: ViewType<any>) => Promise<any>;
    changeContainer?: (fromView: ViewType<any>, eventType: ChangeContainerEventType) => Promise<any>;
}
